...
* **Metabolismo (Desgaste):** La Vitalidad del cultivo base (Zona 1) se reduce automáticamente en -1 punto. (Nota: Los valores de Vitalidad y Acidez nunca pueden bajar de 0 ). Como la Acción A repone +1 una vez al día, un jugador que alimenta a diario **orbita en su Vitalidad inicial**, que es 2 (ver PLAYER_STATE.md §2) — de ahí que «Aletargamiento Invernal» (-2) lo deje en 1 y no en 0.
