...
export const SALA_NUEVA_CHIP = 'nueva'
export const SONIDO_ACTIVAR = 'Activar el aviso sonoro de salas nuevas'
export const SONIDO_SILENCIAR = 'Silenciar el aviso sonoro de salas nuevas'
