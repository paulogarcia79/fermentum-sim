...
export const TECNOLOGIAS: Tecnologia[] = [
  { id: 'incubadora', nombre: 'Incubadora', costo: 3, descripcion: 'Cada noche eliges −1/0/+1 casillas de avance en cada masa (acción gratuita «Incubadora», se decide en tu turno). El ajuste dura una sola noche y sirve también en masas que ya estaban fermentando.' },
