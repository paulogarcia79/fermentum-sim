...
export const descripcionesAcciones: Record<IdAccion, string> = {
  ...
  H: 'Solo disponible con Vitalidad en 0 (penalización de -3 Puntos de Maestría). Costo: 5 tokens de Harina (50%, cualquier tipo), sin costo de Agua. Limpia la Contaminación y fija Vitalidad=1, Acidez=1.',
